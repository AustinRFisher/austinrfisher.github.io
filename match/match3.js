...
Match3 = function()
{
    ...
    var createSquare = function(type, typeSpecial, background, col, row)
    {
        ...
        if (popupBoolean10 == true){
          if (moves == 10 ){
            popupBoolean10 = false;

                // skipObject.setVisible(true);
                // skipArrowObject.setVisible(true);
                // popUpObject.setVisible(true);
                name = prompt("Need Help? Give us your NAME for TWO extra moves!");
                if (name == ''){
        ...
        if (popupBoolean5 == true){
          if (moves == 5 ){
            popupBoolean5 = false;
                ...
                // skipArrowObject.setVisible(true);
                // popUpObject.setVisible(true);
                age = prompt("Why don't you give us your AGE for TWO more extra moves?");
                if (age == ''){
        ...
        if (popupBoolean1 == true){
          if (moves == 1 ){
            popupBoolean1 = false;
                ...
                // skipArrowObject.setVisible(true);
                // popUpObject.setVisible(true);
                country = prompt("Almost done! Give us your COUNTRY for an extra TWO moves!");
                if (country == ''){
    ...
    var swap = function(square1, square2, checkForMatches)
    {
        ...
        {
          speechText.setText('That did\nnot work,\nyou need to\nmatch\nTHREE!');
          speechTextObject.setPosition(-294, 287);
          speechTextObject.setVisible(true);
          boyObject.setVisible(false);
          boyTalkObject.setVisible(false);
          boyMadObject.setVisible(true);
        ...
        square1.onMoveComplete = square2.onMoveComplete = function()
        {
            if (++numMoveCompleted == 2)
            {
                ...
                if (!anyMatches)
                {
                    ...
                    if (square1.isSpecialFive || square2.isSpecialFive){
                      speechText.setText('Awesome job!\nKeep\ncollecting\nthat data!');
                      speechTextObject.setPosition(-294,310);
                      speechTextObject.setVisible(true);
                      boyObject.setVisible(false);
                      boyTalkObject.setVisible(true);
                ...
                else
                {
                  if (moves % 2 > 0 && moves > 3){
                    ...
                    boyTalkObject.setVisible(true);
                    boyMadObject.setVisible(false);
                  } else if (moves % 2 == 0 && moves > 3){
                    speechText.setText('Fantastic!\nKeep going!');
                    speechTextObject.setPosition(-294,335);
                    speechTextObject.setVisible(true);
...

    {
        ...
        // Add time
        if (square.type == "images/nameBoard.png"){
          carryOverMatch = 1;
        } else if(square.type == "images/gender.png"){
          carryOverMatch = 2;
        } else if(square.type == "images/location.png"){
          carryOverMatch = 3;
        } else if(square.type == "images/credit.png"){
          carryOverMatch = 4;
        } else if(square.type == "images/cake.png"){
          carryOverMatch = 5;
        }
        ...
        else if(length == 4)
        {
            ...
            if (bombBoolean == true){
                alert("HEY! You just made a bomb. Match it with similar data to create an explosion!");
                bombBoolean = false;
            }
        ...
        else // Must be a match of 5 or greater
        {
            ...
            if (cookieBoolean == true){
              alert("Awesome! You just made a cookie. This can collect a bunch of data at once! Swap with any data to remove it from the field.");
              cookieBoolean = false;
            }
        }
